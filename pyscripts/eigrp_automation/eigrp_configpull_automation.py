...
# Prerequisites:
    ...
    # This script piggybacks off of the eigrp_deployment_automation.py script to pull EIGRP config. Runs independently.
...
outfile = f"Routers_eigrp_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt"        # Variable to print out the text file with a timestamp
